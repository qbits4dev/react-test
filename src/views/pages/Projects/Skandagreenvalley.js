...
export default function Skandagreenvalley() {
    ...
    const plots = [
        { plotNo: 'A1', area: '1200 sq.ft', price: '₹12,00,000' },
        { plotNo: 'A2', area: '1500 sq.ft', price: '₹15,00,000' },
        { plotNo: 'B1', area: '1800 sq.ft', price: '₹18,00,000' },
    ]
                        ...
                        <CCardBody>
                            ...
                            <div className="text-center mt-4">
                                <CButton
                                    ...
                                    onClick={() => navigate('/bookSite')} // React Router navigation
