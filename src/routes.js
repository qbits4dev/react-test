...
const PrivacyStatic = React.lazy(() => import('./views/pages/PrivacyStatic'))
const DeleteAccountStatic = React.lazy(() => import('./views/pages/DeleteAccountStatic'))
...
const routes = [
  ...
  { path: '/GetClients', name: 'View Leads', element: GetClients,meta:{allowedRoles:["admin","agent"]} },
  ...
  { path: '/register_cilent', name: 'Add Leads', element: RegisterClient ,meta:{allowedRoles:["admin","agent"]}},
  ...
  { path: '/delete-account', name: 'Delete Account', element: DeleteAccountStatic },
  { path: '/delete-account/*', name: 'Delete Account (trailing slash)', element: DeleteAccountStatic },
