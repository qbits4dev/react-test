...
const routes = [
  ...
  { path: '/privacy', name: 'Privacy Policy', element: PrivacyStatic ,meta:{allowedRoles:["admin","agent","customer"]}},
  { path: '/delete-account', name: 'Delete Account', element: DeleteAccountStatic ,meta:{allowedRoles:["admin","agent","customer"]}},
